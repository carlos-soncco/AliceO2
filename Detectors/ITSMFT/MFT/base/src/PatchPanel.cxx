...
TGeoVolumeAssembly* PatchPanel::createPatchPanel(Int_t half)
{
  ...
  Double_t x_tria2[6] = {
      -52,    -45.6,  -45.6,
      -37.17, -38.06, -52}; // 93,93,73,73,-15};//vertices 38.06->36.77
  Double_t y_tria2[6] = {-21.62, -21.62, -11.478,
                         -5.9,   -3,     -3}; // 357.5,357.5,250.78,145.91};
  ...
  // new  ...
  auto *baseA_Shape_0 = new TGeoCompositeShape(
  ...
  auto *baseA_Shape_1 = new TGeoCompositeShape(
              "baseA_Shape_1",
  ...
  auto *baseA_Shape_3 = new TGeoCompositeShape( "baseA_Shape_3", " baseA_Shape_0:rot_A + baseA_Shape_1:rot_A + baseA_Shape_2:rot_A");

  // auto * baseA0_Volume = new
  // TGeoVolume("base0_Volume",baseA_Shape_0,kMedAlu); auto * baseA1_Volume = new
  // TGeoVolume("base1_Volume",baseA_Shape_1,kMedAlu); auto * baseA2_Volume = new
  // TGeoVolume("base2_Volume",baseA_Shape_2,kMedAlu);

  // auto * faceA_Volume = new TGeoVolume("faceA_Volume",baseA_Shape_3,kMedAlu);

  /// faceA_Volume->SetLineColor(5);

  // baseA0_Volume->SetLineColor(5);
  // baseA1_Volume->SetLineColor(5);
  // baseA2_Volume->SetLineColor(5); //2

  // auto* face_A = new TGeoVolumeAssembly("face_A");

  /// face_A->AddNode(baseA3_Volume,1);
  // face_A->AddNode(baseA1_Volume,1);
  // face_A->AddNode(baseA2_Volume,2);

  auto *tr_posA = new TGeoTranslation("tr_posB", 0, 0, 80);

  // PatchPanelVolume->AddNode(baseA0_Volume,1,tr_posA);
  // PatchPanelVolume->AddNode(baseA1_Volume,2,tr_posA);
  // PatchPanelVolume->AddNode(baseA2_Volume,1,tr_posA);
  // PatchPanelVolume->AddNode(face_A,1,tr_posA);
  ...
  auto *baseB_Shape_0 = new TGeoCompositeShape(
  ...
  auto *baseB_Shape_1 = new TGeoCompositeShape(
      "baseB_Shape_1",
  ...
  auto *baseB_Shape_2 = new TGeoCompositeShape(
      "baseB_Shape_2", " baseB_Shape_0:tra_B + baseB_Shape_1:tra_B");
  ...
  // auto * base0_Volume = new TGeoVolume("base0_Volume",baseB_Shape_0,kMedAlu);
