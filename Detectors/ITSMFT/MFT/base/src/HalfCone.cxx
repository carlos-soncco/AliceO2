...
TGeoVolumeAssembly *HalfCone::createHalfCone(Int_t half) {
  ...
  auto *c_mb0_Shape_0 = new TGeoCompositeShape(
      "c_mb0_Shape_0", "box_mb0  - hole2_mb0:combi_2hole_mb0 - "
  ...
  auto *c_cbeam_Shape = new TGeoCompositeShape(
      "c_cbeam_Shape", " s_cb:rot_cb - hole_cbeam:combi_hole_1cbeam - "
  ...
  auto *RL_Shape_0 = new TGeoCompositeShape(
      "RL_Shape_0", "  S_XTRU_RL1 + S_XTRU_RL2 + RL_1box:tr_RL_1box - "
                    "qdi_box:combi_qdi + "
  ...
  /// composite shape for mb0
  auto *c_mb_Shape_0 =
      new TGeoCompositeShape("box_cmb:rot_1c_mb0 + tub_cmb:acombi_1c_mb0 + "
