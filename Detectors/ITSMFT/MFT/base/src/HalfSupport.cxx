...
////////////////////////////////////////////
   ...
   TGeoRotation  *rot_halfR = new TGeoRotation("rot_halfR", 180,180,0);//half0_R
     ...
     TGeoCombiTrans *combi_front_R = new TGeoCombiTrans(7.1, -16.2, 32.5,rot_z180x90);//x=7.35, y=0, z=15.79
 ...
 /////////////////////// shape for rail MB  /////////
  ...
  /////////////////////////////////////////////////  =|=|=
   ...
   ///-   HalfSupportVolume->AddNode(Fra_front_R,5,new TGeoTranslation(0,0,-80));//-7.1,-16.2,32.5-80
        HalfSupportVolume->AddNode(Fra_front,4,new TGeoCombiTrans(0,0,-80));    
